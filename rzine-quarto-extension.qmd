---
title: "Titre article"
subtitle: "Sous-titre article méthodologique Rzine"
date: 01/06/2024
date-modified: last-modified
author:
  - name: Team Rzine
    corresponding: true
    email: contact@srzine.fr
    url: https://rzine.fr/
    orcid: 0000-0000-0000-0000
    affiliations:
      - name: CNRS
        department: Ingénieurie
        address: Campus Condorcet
        city: Paris
        country: France
        postal-code: 	93300
  - name: a friend
    affiliations:
      - Another Affiliation
description: |
  Ce document fournit un modèle de mise en page basé sur le système de publication Quarto pour la collection d'artiocle méthodologique Rzine.
...
citation:
  ...
  doi: "10.xxxx/xxx-xxx"
  url: "https://github.com/rzine-reviews/rzine-quarto-extension"
  issn: "xxxx-xxxx"
bibliography: references.bib
google-scholar: true
github-user: rzine-reviews
repo: "rzine-quarto-extension"
